...
#復活回数が0なら復活なしの表記、1..なら通常通り表示
    ...
    execute if score dummyplayer Awpvp.elim_LifeSetting matches 0 run data merge block ~ ~ ~ {front_text:{color:"orange",has_glowing_text:1b,messages:['{"text":""}','{"text":"復活回数を変更","underlined":true,"clickEvent":{"action":"run_command","value":"/function awpvp:sign/mode_setting/elimination_life"}}','[{"text":"現在："},{"text":"復活なし","color":"green"}]','{"text":""}']}}
